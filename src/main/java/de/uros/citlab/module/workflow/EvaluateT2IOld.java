 ...
 * @author gundram
 */
public class EvaluateT2IOld extends ParamTreeOrganizer {

    private static final long serialVersionUID = 1L;
    private static final Logger LOG = Logger.getLogger(EvaluateT2IOld.class.getName());
...
//    private boolean createDebug;
    ...
    public EvaluateT2IOld() {
        this("", "", 0.4, 10.0);
    }

    public EvaluateT2IOld(String gt, String hyp, double threshold, double ratio) {
        this.gt = gt;
        this.hyp = hyp;
//        debug = createDebugImg;
        ...
        this.ratio = ratio;
        beta = ratio;
        addReflection(this, EvaluateT2IOld.class);
    }
    ...
    public static void main(String[] args) throws InvalidParameterException, MalformedURLException, IOException, JAXBException, InterruptedException {
        ...
        EvaluateT2IOld instance = new EvaluateT2IOld();
